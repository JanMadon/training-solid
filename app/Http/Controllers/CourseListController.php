...
class CourseListController extends Controller
{
    ...
    public function __invoke(CourseListRequest $request): \Illuminate\Contracts\View\View
    {
        $paginate_count = $request->getQuery()->getPerPage();
        $category_search = $request->getQuery()->getCategoryIds();
        $instruction_level_id = $request->getQuery()->getInstructionLevelIds();
        $prices = $request->getQuery()->getPriceIds();
